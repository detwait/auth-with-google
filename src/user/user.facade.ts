...
export class UserFacade {
  ...
  auth = {
    ...
    signUp: (userParams: UserCreateParams, entityManager?: EntityManager): Promise<UserEntity> => this.userAuthService.signUp(userParams, entityManager),
  ...
  profile = {
    setBirthday: (userId: string, birthdayDate: Date): Promise<UserTokensDto> => this.userProfileService.setBirthday(userId, birthdayDate),
  }
}
